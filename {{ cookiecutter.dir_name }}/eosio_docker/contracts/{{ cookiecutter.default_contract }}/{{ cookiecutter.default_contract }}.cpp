...
// Smart Contract Name: {{ cookiecutter.default_contract }}
// Table struct:
...
class {{ cookiecutter.default_contract }} : public eosio::contract {
  private:
...
EOSIO_ABI( {{ cookiecutter.default_contract }}, (update) )
